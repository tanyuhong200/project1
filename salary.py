...
employment_type = st.selectbox("Employment Type", ['FL', 'FT', 'PT'])
experience_level = st.selectbox("Experience Level", ['EX', 'MI', 'SE'])
company_size = st.selectbox("Company Size", ['S', 'M'])
 
job_title = st.selectbox("Job Title", ['Data Engineer', 'Data Scientist', 'Engineer', 'Software Engineer', 'Other'])
company_location = st.selectbox("Company Location", ['CA', 'GB', 'NL', 'US', 'Other'])
employee_residence = st.selectbox("Employee Residence", ['CA', 'GB', 'US', 'Other'])
